	                ...
	                <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
	                    ...
	                    <div class="carousel-inner">
	                        <div class="item active carousel-img">
	                            <img class="slide-image" src="https://s3-sa-east-1.amazonaws.com/sweetmanu/banner1.jpg" alt="">
	                        </div>
	                        <div class="item carousel-img">
	                            <img class="slide-image" src="https://s3-sa-east-1.amazonaws.com/sweetmanu/banner2.jpg" alt="">
	                        </div>
	                        <div class="item carousel-img">
	                            <img class="slide-image" src="https://s3-sa-east-1.amazonaws.com/sweetmanu/banner3.jpg" alt="">
	                        </div>
	                    </div>
