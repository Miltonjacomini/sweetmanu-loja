...
<div id="wrapper-header">
	<div id="main-header" class="object">
		<div class="logo">
			<img src="${contextPath}/resources/assets/img/logo-burst.png" alt="logo platz" height="38" width="90">
		</div>
    </div>
</div>
...
<div id="wrapper-navbar">
		<div class="navbar object">
            ...
            <div id="wrapper-bouton-icon">
            	<div id="bouton-ai"><img src="${contextPath}/resources/assets/img/icon-ai.svg" alt="illustrator" title="Illustrator" height="28" width="28"></div>
            	<div id="bouton-psd"><img src="${contextPath}/resources/assets/img/icon-psd.svg" alt="photoshop" title="Photoshop" height="28" width="28"></div>
            	<div id="bouton-theme"><img src="${contextPath}/resources/assets/img/icon-themes.svg" alt="theme" title="Theme" height="28" width="28"></div>
            	<div id="bouton-font"><img src="${contextPath}/resources/assets/img/icon-font.svg" alt="font" title="Font" height="28" width="28"></div>
            	<div id="bouton-photo"><img src="${contextPath}/resources/assets/img/icon-photo.svg" alt="photo" title="Photo" height="28" width="28"></div>
            	<div id="bouton-premium"><img src="${contextPath}/resources/assets/img/icon-premium.svg" alt="premium" title="Premium" height="28" width="28"></div>
			</div>
    	</div>
    </div>
		...
		<div class="container object">
			...
			<div id="main-container-image">
					...
					<section class="work">
						...
						<figure class="white">
							<a href="details.html">
								<img src="${contextPath}/resources/assets/img/psd-4.jpg" alt="" />
								<dl>
                            ...
                            <div id="wrapper-part-info">
                            	<div class="part-info-image"><img src="${contextPath}/resources/assets/img/icon-psd.svg" alt="" width="28" height="28"/></div>
						...
						<figure class="white">
							<a href="#">
								<img src="${contextPath}/resources/assets/img/font-1.jpg" alt="" />
								<dl>
									<dt>Free font</dt>
                            ...
                            <div id="wrapper-part-info">
                            	<div class="part-info-image"><img src="${contextPath}/resources/assets/img/icon-font.svg" alt="" width="28" height="28"/></div>
						...
						<figure class="white">
							<a href="#">
								<img src="${contextPath}/resources/assets/img/psd-1.jpg" alt="" />
								<dl>
									<dt>PSD Goodies</dt>
						...
						<figure class="white">
							<a href="#">
								<img src="${contextPath}/resources/assets/img/psd-2.jpg" alt="" />
								<dl>
									<dt>PSD Goodies</dt>
						...
						<figure class="white">
							<a href="#">
								<img src="${contextPath}/resources/assets/img/ai-1.jpg" alt="" />
								<dl>
                            ...
                            <div id="wrapper-part-info">
                            	<div class="part-info-image"><img src="${contextPath}/resources/assets/img/icon-ai.svg" alt="" width="28" height="28"/></div>
						...
						<figure class="white">
							<a href="#">
								<img src="${contextPath}/resources/assets/img/theme-2.jpg" alt="" />
								<dl>
									<dt>Html theme</dt>
									<dd>Symphony is a responsive one page website template designed with sketches and coded with html5 and php. Freebie released by Lacoste Xavier.</dd>	
								</dl>
                            ...
                            <div id="wrapper-part-info">
                            	<div class="part-info-image"><img src="${contextPath}/resources/assets/img/icon-themes.svg" alt="" width="28" height="28"/></div>
						...
						<figure class="white">
							<a href="#">
								<img src="${contextPath}/resources/assets/img/psd-3.jpg" alt="" />
								<dl>
									<dt>PSD goodies</dt>
						...
						<figure class="white">
							<a href="#">
								<img src="${contextPath}/resources/assets/img/font-2.jpg" alt="" />
								<dl>
									<dt>Free font</dt>
						...
						<figure class="white">
							<a href="#">
								<img src="${contextPath}/resources/assets/img/font-3.jpg" alt="" />
								<dl>
									<dt>Wordpress theme</dt>
									<dd>Symphony is a responsive one page website template designed with sketches and coded with html5 and php. Freebie released by Lacoste Xavier.</dd>	
								</dl>
						...
						<figure class="white">
							<a href="#">
								<img src="${contextPath}/resources/assets/img/ai-2.jpg" alt="" />
								<dl>
						...
						<figure class="white">
							<a href="#">
								<img src="${contextPath}/resources/assets/img/icons-1.jpg" alt="" />
								<dl>
									<dt>PSD icons</dt>
						...
						<figure class="white">
							<a href="#">
								<img src="${contextPath}/resources/assets/img/ui-1.jpg" alt="" />
								<dl>
									<dt>UI design</dt>
                            ...
                            <div id="wrapper-part-info">
                            	<div class="part-info-image"><img src="${contextPath}/resources/assets/img/icon-premium.svg" alt="" width="28" height="28"/></div>
                        ...
                        <figure class="white">
							<a href="#">
								<img src="${contextPath}/resources/assets/img/font-5.jpg" alt="" />
								<dl>
									<dt>Free font</dt>
									<dd>A set of 6 outline beer icons created with Adobe Illustrator. Free Ai designed and released by Justas Galaburda.</dd>	
								</dl>
						...
						<figure class="white">
							<a href="#">
								<img src="${contextPath}/resources/assets/img/psd-5.jpg" alt="" />
								<dl>
									<dt>PSD mockup</dt>
						...
						<figure class="white">
							<a href="#">
								<img src="${contextPath}/resources/assets/img/icons-3.jpg" alt="" />
								<dl>
									<dt>PSD icons</dt>
						...
						<figure class="white">
							<a href="#">
								<img src="${contextPath}/resources/assets/img/font-4.jpg" alt="" />
								<dl>
									<dt>Free font</dt>
						...
						<figure class="white">
							<a href="#">
								<img src="${contextPath}/resources/assets/img/theme-3.jpg" alt="" />
								<dl>
									<dt>HTML theme</dt>
						...
						<figure class="white">
							<a href="#">
								<img src="${contextPath}/resources/assets/img/font-6.jpg" alt="" />
								<dl>
									<dt>Free font</dt>
						...
						<figure class="white">
							<a href="#">
								<img src="${contextPath}/resources/assets/img/theme-4.jpg" alt="" />
								<dl>
									<dt>HTML theme</dt>
